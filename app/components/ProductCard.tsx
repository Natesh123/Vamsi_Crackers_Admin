    ...
    return (
        <div className="group relative w-full bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl hover:border-festive-gold/50 transition-all duration-500 flex flex-col">
            ...
            <div className="relative h-60 w-full overflow-hidden bg-gray-50">
                ...
                {/* Sale Badge */}
                {originalPrice > price && (
                    <div className="absolute top-4 left-4 bg-festive-red text-white text-xs font-bold px-3 py-1.5 rounded-lg uppercase tracking-wider shadow-md">
                ...
                {/* Offer % */}
                {originalPrice > price && (
                    <div className="absolute top-4 right-4 bg-festive-gold text-festive-purple text-xs font-bold px-3 py-1.5 rounded-lg uppercase tracking-wider shadow-md">
                        {discountPct}% OFF
                    </div>
                )}
            </div>
